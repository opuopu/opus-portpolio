...
const Header = () => {
   ...
   <Navbar.Collapse id="responsive-navbar-nav">
    <Nav  className="ms-auto">
      ...
      <Nav.Link  className="navs" as={Link} to="/about"> <i class="fas fa-tasks"></i> About</Nav.Link>
      ...
      <Nav.Link  className="navs" as={Link} to="/blog"> <i class="fab fa-blogger"></i> Blog</Nav.Link>
